...
test('STEP業務ホームを正式な本番システムとして登録する',()=>{
  assert.match(registry,/登録システム（29件）/);
  ...
  assert.match(html,/共有設定版5を基礎にした7項目・43カード/);
});
