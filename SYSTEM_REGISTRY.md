...
- 配布物: OneDriveの `証憑自動回収アプリ/証憑自動回収アプリ_新しいPC用_v1.5.2.zip`。Node.jsと必要部品を同梱した新しいPC用完成版であり、Node.jsの別途インストールは不要。同じOneDriveアカウントで新しいPCへ同期する。配布ZIPや取得した証憑PDFは個人情報を含む可能性があるため、公開GitHubへ置かない
