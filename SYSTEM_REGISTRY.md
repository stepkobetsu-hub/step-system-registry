...
- 本番確認: 2026年度APIで在籍生90名・中学生65名を取得し、登録済み学校コードを既存中学生64名へ反映、未登録校1校を登録画面に表示、API警告0件・受験番号重複0件であることを2026-08-19に確認。フロントエンドは `exam_ticket.js?v=20260819-11`／`exam_ticket.css?v=20260819-7`。中学校コード見出しの1行固定と、氏名欄の大型化・学年併記を確認。Apps Scriptはv56。
