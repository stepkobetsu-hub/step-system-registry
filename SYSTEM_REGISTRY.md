...
| 遅刻・欠席・早退連絡 | 本番使用中（管理者メール一覧の2段表示対応） | https://stepkobetsu-hub.github.io/step-form/ | [step-form](https://github.com/stepkobetsu-hub/step-form) | `main`（件名対応 `eca3851`） | `index.html`、Apps Script project `1d5p77ukBLgeWBJ0cKwCB0ZUui4iVkI-IMIeJqp_15GH3QtzByv3O6xGC`、[Apps Script編集画面](https://script.google.com/u/0/home/projects/1d5p77ukBLgeWBJ0cKwCB0ZUui4iVkI-IMIeJqp_15GH3QtzByv3O6xGC/edit)、[回答Google Sheet](https://docs.google.com/spreadsheets/d/1c2He5p_FMXGq0Gor74wIrJKtdBvTdjmO992ZkNSVuLQ/edit)、`★欠席遅刻` | GitHub Pages＋Google Apps Script Webアプリ＋Google Sheet | 画面変更はGitHub `main`、メール・保存処理はApps Script編集画面から既存デプロイIDを維持して更新 | 2026-08-25 | 管理者メール一覧：件名は`氏名【神領】`または`氏名【大手】`。本文1行目（一覧プレビュー）は`欠席`、`遅刻:5～15分`、`遅刻:15～30分`、`遅刻:30分以上`、`早退希望`。`新しい連絡が届きました`は表示しない。実行URLは既存Webアプリを維持 |
...
- 回答正本シート: `★欠席遅刻`
- 2026-08-25管理者メール一覧仕様: 件名は氏名直後に神領校`【神領】`、大手町校`【大手】`を付ける。本文1行目は`欠席`、`遅刻:5～15分`、`遅刻:15～30分`、`遅刻:30分以上`、`早退希望`とし、`新しい連絡が届きました`は削除する
- GitHub件名対応コミット: `eca3851dfdbf8dba35b6010ec843200ea9dc16bb`
